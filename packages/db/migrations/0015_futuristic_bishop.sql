...
CREATE TABLE "oauth_applications" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "oauth_applications_client_id_uk" UNIQUE("client_id")
);
--> statement-breakpoint
...
CREATE UNIQUE INDEX "oauth_access_tokens_access_token_uk" ON "oauth_access_tokens" USING btree ("access_token");--> statement-breakpoint
CREATE UNIQUE INDEX "oauth_access_tokens_refresh_token_uk" ON "oauth_access_tokens" USING btree ("refresh_token");--> statement-breakpoint
